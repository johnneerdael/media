...
final class FfmpegVideoDecoder extends
    ...
    // LINT.ThenChange(../../../../../../../jni/ffvideo.cpp)
    ...
    public FfmpegVideoDecoder(int numInputBuffers, int numOutputBuffers, int initialInputBufferSize, int threads, Format format) throws FfmpegDecoderException {
        ...
        nativeContext =
                ffmpegInitialize(
                        ...
                        extraData,
                        threads,
                        FfmpegLibrary.isExperimentalDv5ToneMapToSdrEnabled());
        if (nativeContext == 0) {
    ...
    private native long ffmpegInitialize(
            String codecName, @Nullable byte[] extraData, int threads, boolean enableToneMapToSdr);
