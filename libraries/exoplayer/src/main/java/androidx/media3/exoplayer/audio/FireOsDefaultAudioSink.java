 ...
 */
@UnstableApi
public final class FireOsDefaultAudioSink implements AudioSink {
  ...
  public interface AudioTrackProvider {
    ...
    AudioTrackProvider DEFAULT =
        new AudioTrackProvider() {
          private final DefaultAudioSink.AudioTrackProvider delegate = new DefaultAudioTrackProvider();
          ...
          public AudioTrack getAudioTrack(
            ...
            return delegate.getAudioTrack(audioTrackConfig, audioAttributes, audioSessionId, context);
          }

          @Override
          public int getAudioTrackChannelConfig(int channelCount) {
            return delegate.getAudioTrackChannelConfig(channelCount);
          }
        };
  ...
  public interface AudioTrackBufferSizeProvider {
    ...
    AudioTrackBufferSizeProvider DEFAULT =
        new AudioTrackBufferSizeProvider() {
          ...
          public int getBufferSizeInBytes(
            ...
            return delegate.getBufferSizeInBytes(
  ...
  /** A builder to create {@link FireOsDefaultAudioSink} instances. */
  ...
  public static final class Builder {
     ...
     *
     * <p>If this setter is not called, then the {@link FireOsDefaultAudioSink} uses an instance of {@link
    ...
    /** Builds the {@link FireOsDefaultAudioSink}. Must only be called once per Builder instance. */
    public FireOsDefaultAudioSink build() {
      ...
      if (audioOutputProvider == null) {
        if (audioOffloadSupportProvider == null) {
          DefaultAudioOffloadSupportProvider delegate = new DefaultAudioOffloadSupportProvider(context);
          audioOffloadSupportProvider = delegate::getAudioOffloadSupport;
        }
        ...
        audioOutputProvider =
            new AudioTrackAudioOutputProvider.Builder(context)
                ...
                .setAudioOffloadSupportProvider(audioOffloadSupportProvider::getAudioOffloadSupport)
                ...
                .setAudioTrackProvider(
                    new DefaultAudioSink.AudioTrackProvider() {
                      @Override
                      public AudioTrack getAudioTrack(
                          AudioTrackConfig audioTrackConfig,
                          AudioAttributes audioAttributes,
                          int audioSessionId,
                          @Nullable Context context) {
                        return audioTrackProvider.getAudioTrack(
      ...
      return new FireOsDefaultAudioSink(this);
    }
  }
  ...
  private static final String TAG = "FireOsDefaultAudioSink";
  ...
  @Nullable private FireOsIec61937AudioOutputProvider fireOsAudioOutputProvider;
  ...
  @Nullable private FireOsPassthroughSession fireOsPassthroughSession;
  @Nullable private FireOsIec61937AudioOutputProvider.PreparedEncodedPacket pendingFireOsPreparedPacket;
  ...
  private FireOsDefaultAudioSink(Builder builder) {
    ...
    fireOsAudioOutputProvider =
        builder.audioOutputProvider instanceof FireOsIec61937AudioOutputProvider
            ? (FireOsIec61937AudioOutputProvider) builder.audioOutputProvider
            : null;
    fireOsPassthroughSession = null;
    virtualDeviceId =
  ...
  public void configure(Format inputFormat, int specifiedBufferSize, @Nullable int[] outputChannels)
    ...
    updateFireOsSessionForConfiguration(pendingConfiguration);
  }
  ...
  public boolean handleBuffer(
    ...
    clearFireOsPreparedPacketState(/* buffer= */ null);
    return handleBufferInternal(buffer, presentationTimeUs, encodedAccessUnitCount);
  }

  public boolean handleBufferWithMetadata(
      ByteBuffer buffer, long presentationTimeUs, int encodedAccessUnitCount, Format format)
      throws InitializationException, WriteException {
    if (inputBuffer != buffer) {
      clearFireOsPreparedPacketState(/* buffer= */ null);
      pendingFireOsPreparedPacket =
          fireOsAudioOutputProvider != null
              ? fireOsAudioOutputProvider.prepareEncodedPacket(
                  format, buffer, encodedAccessUnitCount)
              : null;
    }
    return handleBufferInternal(buffer, presentationTimeUs, encodedAccessUnitCount);
  }
  ...
  private boolean handleBufferInternal(
    ...
    if (inputBuffer == null) {
      ...
      if (!buffer.hasRemaining()) {
        // The buffer is empty.
        clearFireOsPreparedPacketState(buffer);
        return true;
      }

      if (!configuration.isPcm() && framesPerEncodedSample == 0) {
        // If this is the first encoded sample, calculate the sample size in frames.
        @Nullable FireOsIec61937AudioOutputProvider.BufferMetadata fireOsBufferMetadata =
            inspectFireOsEncodedBuffer(buffer, encodedAccessUnitCount);
        if (fireOsBufferMetadata != null) {
          framesPerEncodedSample =
              fireOsBufferMetadata.normalizedAccessUnitCount > 0
                  ? max(
                      1,
                      fireOsBufferMetadata.totalFrames / fireOsBufferMetadata.normalizedAccessUnitCount)
                  : 0;
        } else {
          framesPerEncodedSample =
      ...
      if (configuration.isPcm()) {
        ...
        @Nullable FireOsIec61937AudioOutputProvider.BufferMetadata fireOsBufferMetadata =
            inspectFireOsEncodedBuffer(buffer, encodedAccessUnitCount);
        if (fireOsBufferMetadata != null) {
          submittedEncodedFrames += fireOsBufferMetadata.totalFrames;
          checkNotNull(fireOsPassthroughSession)
              .onInputBufferSubmitted(fireOsBufferMetadata, presentationTimeUs);
        } else {
  ...
  private AudioOutput buildAudioOutputWithRetry() throws InitializationException {
    try {
      ...
      if (maybeReconfigureFireOsOutputAfterInitializationFailure(initialFailure)) {
        return buildAudioOutput(configuration.outputConfig);
      }
  ...
  private AudioOutput buildAudioOutput(OutputConfig outputConfig) throws InitializationException {
    try {
      ...
      boolean isFireOsPassthroughRecoverable =
          fireOsAudioOutputProvider != null
              && configuration != null
              && !configuration.isPcm()
              && outputConfig.encoding != C.ENCODING_INVALID;
      InitializationException exception =
          new InitializationException(
              ...
              /* isRecoverable= */ outputConfig.isOffload || isFireOsPassthroughRecoverable,
              e);
      if (listener != null) {
  ...
  private void drainOutputBuffer(long avSyncPresentationTimeUs) throws WriteException {
    ...
    try {
      ...
      if (shouldRetry) {
        boolean preparedFallback = maybePrepareFireOsFallbackAfterWriteFailure(error);
        if (preparedFallback) {
          flush();
        }
      }
    ...
    if (configuration.isPcm()) {
      ...
      if (fullyHandled) {
        if (!configuration.isPcm()) {
          ...
          @Nullable FireOsIec61937AudioOutputProvider.BufferMetadata fireOsBufferMetadata =
              currentFireOsBufferMetadata();
          if (fireOsBufferMetadata != null) {
            writtenEncodedFrames += fireOsBufferMetadata.totalFrames;
            checkNotNull(fireOsPassthroughSession).onBufferWritten(fireOsBufferMetadata);
          } else {
  ...
  public void setAudioOutputProvider(AudioOutputProvider audioOutputProvider) {
    ...
    this.audioOutputProvider = audioOutputProvider;
    fireOsAudioOutputProvider =
        audioOutputProvider instanceof FireOsIec61937AudioOutputProvider
            ? (FireOsIec61937AudioOutputProvider) audioOutputProvider
            : null;
  ...
  private void clearFireOsPreparedPacketState(@Nullable ByteBuffer buffer) {
    if (fireOsAudioOutputProvider != null && buffer != null) {
      fireOsAudioOutputProvider.discardPreparedPacket(buffer);
    }
    pendingFireOsPreparedPacket = null;
  }
  ...
  public void pause() {
    ...
    if (fireOsPassthroughSession != null) {
      fireOsPassthroughSession.onPause();
    }
    if (isAudioOutputInitialized()) {
      audioOutput.pause();
    }
  ...
  public void flush() {
    if (isAudioOutputInitialized()) {
      if (fireOsPassthroughSession != null) {
        fireOsPassthroughSession.onFlush();
      }
    ...
    if (fireOsAudioOutputProvider != null) {
      fireOsAudioOutputProvider.resetSessionState();
    }
    pendingFireOsPreparedPacket = null;
    writeExceptionPendingExceptionHolder.clear();
    initializationExceptionPendingExceptionHolder.clear();
  ...
  private void reconfigureAndFlush() {
    if (configuration != null) {
      ...
      updateFireOsSessionForConfiguration(configuration);
    }
    flush();
  }

  private void resetSinkStateForFlush() {
    clearFireOsPreparedPacketState(inputBuffer);
    submittedPcmBytes = 0;
    ...
    if (fireOsPassthroughSession != null) {
      fireOsPassthroughSession.onSinkStateReset();
    }
    pendingFireOsPreparedPacket = null;
  }
  ...
  @Nullable
  private FireOsIec61937AudioOutputProvider.BufferMetadata inspectFireOsEncodedBuffer(
      ByteBuffer buffer, int encodedAccessUnitCount) {
    if (fireOsAudioOutputProvider == null || configuration == null || configuration.isPcm()) {
      return null;
    }
    @Nullable FireOsIec61937AudioOutputProvider.PreparedEncodedPacket preparedPacket =
        pendingFireOsPreparedPacket;
    FireOsIec61937AudioOutputProvider.BufferMetadata metadata;
    if (preparedPacket != null && preparedPacket.encodedAccessUnitCount == encodedAccessUnitCount) {
      fireOsAudioOutputProvider.registerPreparedPacket(buffer, preparedPacket);
      metadata = preparedPacket.metadata;
    } else {
      metadata =
          fireOsAudioOutputProvider.inspectEncodedBuffer(
              configuration.inputFormat, buffer, encodedAccessUnitCount);
    }
    if (metadata != null && fireOsPassthroughSession != null) {
      fireOsPassthroughSession.currentBufferMetadata = metadata;
    }
    return metadata;
  }

  @Nullable
  private FireOsIec61937AudioOutputProvider.BufferMetadata currentFireOsBufferMetadata() {
    return fireOsPassthroughSession != null ? fireOsPassthroughSession.currentBufferMetadata : null;
  }

  private void maybePrimeFireOsStreamInfoBeforeInitialization(
    ...
    @Nullable FireOsIec61937AudioOutputProvider.BufferMetadata metadata =
        inspectFireOsEncodedBuffer(buffer, encodedAccessUnitCount);
    if (metadata == null) {
      return;
    }
    fireOsAudioOutputProvider.updateStreamInfo(configuration.afterProcessingInputFormat, metadata.streamInfo);
    if (fireOsPassthroughSession != null) {
      fireOsPassthroughSession.onStreamInfoAvailable(metadata.streamInfo, presentationTimeUs);
    }
    refreshFireOsOutputConfigFromStreamInfo(metadata.streamInfo);
  }
  ...
  private void refreshFireOsOutputConfigFromStreamInfo(FireOsStreamInfo streamInfo)
    ...
    try {
      OutputConfig refreshedConfig =
          audioOutputProvider.getOutputConfig(getFormatConfig(configuration.afterProcessingInputFormat));
      if (!refreshedConfig.equals(configuration.outputConfig)) {
        configuration = configuration.copyWithOutputConfig(refreshedConfig);
        if (fireOsPassthroughSession != null) {
          fireOsPassthroughSession.onOutputConfigRefreshed(streamInfo, refreshedConfig);
        }
        Log.i(
            TAG,
            "Fire OS refreshed output config from stream info"
                + " streamInfo="
                + streamInfo.summary()
                + " encoding="
                + refreshedConfig.encoding
                + " sampleRate="
                + refreshedConfig.sampleRate
                + " channelMask="
                + refreshedConfig.channelMask);
      }
      if (streamInfo.passthroughCandidate && Util.isEncodingLinearPcm(refreshedConfig.encoding)) {
        Log.e(
            TAG,
            "Fire OS passthrough candidate downgraded to PCM"
                + " streamInfo="
                + streamInfo.summary()
                + " encoding="
                + refreshedConfig.encoding);
  ...
  private void updateFireOsSessionForConfiguration(Configuration configuration) {
    if (fireOsAudioOutputProvider == null || configuration.isPcm()) {
      fireOsPassthroughSession = null;
      return;
    }
    fireOsAudioOutputProvider.resetSessionState();
    String capabilitySummary =
        fireOsAudioOutputProvider.getCapabilitySummary(configuration.outputConfig.channelMask);
    fireOsPassthroughSession =
        new FireOsPassthroughSession(
            configuration.inputFormat.sampleMimeType,
            configuration.outputConfig,
            capabilitySummary);
    Log.i(
        TAG,
        "Fire OS passthrough session configured"
            + " mime="
            + configuration.inputFormat.sampleMimeType
            + " encoding="
            + configuration.outputConfig.encoding
            ...
            + configuration.outputConfig.channelMask
            + " linearPcm="
            + Util.isEncodingLinearPcm(configuration.outputConfig.encoding)
            + " capabilities="
            + capabilitySummary);
  }

  private boolean maybeReconfigureFireOsOutputAfterInitializationFailure(
    ...
    try {
      OutputConfig fallbackConfig =
          audioOutputProvider.getOutputConfig(getFormatConfig(configuration.afterProcessingInputFormat));
      if (!fallbackConfig.equals(configuration.outputConfig)) {
        if (fireOsPassthroughSession != null) {
          fireOsPassthroughSession.outputConfig = fallbackConfig;
        }
        configuration = configuration.copyWithOutputConfig(fallbackConfig);
        Log.w(
            TAG,
            "Fire OS sink retrying with refreshed fallback output config"
                + " streamInfo="
                + (fireOsPassthroughSession != null && fireOsPassthroughSession.streamInfo != null
                    ? fireOsPassthroughSession.streamInfo.summary()
                    : "none"));
        return true;
      }
    } catch (AudioOutputProvider.ConfigurationException e) {
      Log.w(TAG, "Fire OS sink could not refresh fallback output config", e);
    }
    return false;
  }

  private boolean maybePrepareFireOsFallbackAfterWriteFailure(WriteException error) {
    if (fireOsAudioOutputProvider == null || configuration == null) {
      return false;
    }
    if (fireOsPassthroughSession != null) {
    ...
    try {
      ...
      if (!fallbackConfig.equals(configuration.outputConfig)) {
        ...
        Log.w(
            TAG,
            "Fire OS sink prepared fallback output config after recoverable write failure"
                + " streamInfo="
                + (fireOsPassthroughSession != null && fireOsPassthroughSession.streamInfo != null
                    ? fireOsPassthroughSession.streamInfo.summary()
                    : "none"));
  ...
  private static final class FireOsPassthroughSession {
    public final @Nullable String sampleMimeType;
    public final String capabilitySummary;
    public OutputConfig outputConfig;
    public int outputGeneration;
    public int recoverableWriteFailures;
    public int recoverableInitializationFailures;
    public long lastPresentationTimeUs;
    public int refreshedOutputConfigCount;
    @Nullable public FireOsStreamInfo streamInfo;
    @Nullable public FireOsIec61937AudioOutputProvider.BufferMetadata currentBufferMetadata;

    public FireOsPassthroughSession(
        @Nullable String sampleMimeType, OutputConfig outputConfig, String capabilitySummary) {
    ...
    public void onInputBufferSubmitted(
        FireOsIec61937AudioOutputProvider.BufferMetadata metadata, long presentationTimeUs) {
      streamInfo = metadata.streamInfo;
      currentBufferMetadata = metadata;
      lastPresentationTimeUs = presentationTimeUs;
    }

    public void onBufferWritten(FireOsIec61937AudioOutputProvider.BufferMetadata metadata) {
      currentBufferMetadata = null;
    }

    public void onInitializationFailure(InitializationException exception) {
      recoverableInitializationFailures++;
    }

    public void onWriteFailure(WriteException exception) {
      recoverableWriteFailures++;
    }

    public void onStreamInfoAvailable(FireOsStreamInfo streamInfo, long presentationTimeUs) {
      this.streamInfo = streamInfo;
      this.lastPresentationTimeUs = presentationTimeUs;
    }

    public void onOutputConfigRefreshed(FireOsStreamInfo streamInfo, OutputConfig outputConfig) {
      this.streamInfo = streamInfo;
      this.outputConfig = outputConfig;
      this.refreshedOutputConfigCount++;
    }

    public void onPause() {
      // Reserved for Fire OS-specific telemetry and future delay tracking.
    }
